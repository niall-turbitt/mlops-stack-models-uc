...
[ML Config](../mlops_stack_models_uc/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_stack_models_uc/databricks-resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://e2-dogfood-ml-dev.staging.cloud.databricks.com#setting/accounts) and
...
Follow the instructions in [mlops-stack-models-uc/databricks-resources/README.md](../mlops_stack_models_uc/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mlops_stack_models_uc/databricks-resources/README.md)  to propose, test, and deploy
