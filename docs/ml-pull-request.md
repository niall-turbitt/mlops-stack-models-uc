...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-stack-models-uc-run-tests.yml) 
...
* [Staging workspace registered model](https://e2-dogfood-ml-dev.staging.cloud.databricks.com#mlflow/models/staging-mlops-stack-models-uc-model)
* [Prod workspace registered model](https://e2-dogfood.staging.cloud.databricks.com#mlflow/models/prod-mlops-stack-models-uc-model)
