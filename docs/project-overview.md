...
```
mlops-stack-models-uc        <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_stack_models_uc       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
