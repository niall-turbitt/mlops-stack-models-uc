# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [mlops_stack_models_uc/databricks-resources/README.md](../../databricks-resources/README.md)
